...
```bash
python data/download.py   # fetches the dataset from Hugging Face
pip install pandas
...
The most valuable contributions sharpen the model, the evaluation, or the
documented failure modes. Data corrections are welcome too — see above.
